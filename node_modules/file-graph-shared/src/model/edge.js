...
class Edge extends ListenableObject {
    constructor(leftNode, rightNode, { tags = [], constantAttributes = {} } = {}) {
        ...
        this.set('hasHighlightedTag', false);
    ...
    addTag(tag) {
        ...
        this.listenTo(tag, 'change:highlighted', this.updateHasHighlightedTag);
        this.emitEvent('added:tag', tag);
    }

    removeTag(tag) {
        delete this._tags[tag.id];
        this.stopListening(tag, 'change:highlighted', this.updateHasHighlightedTag);
    ...
    hasMeaning() {
        return this.tags.length > 0 || Object.keys(this.constantAttributes).length > 0;
    }
    ...
    updateHasHighlightedTag() {
        this.set('hasHighlightedTag', this.tags.some(t => t.highlighted));
    }
